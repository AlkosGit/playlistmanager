...
class Window:
    ...
    def new(self):
        ...
        self.chkvar = IntVar()
        self.cbres = Checkbutton(self.newframe, variable=self.chkvar, highlightcolor='white', activebackground='#444444', highlightbackground='#444444', foreground='#444444', relief='flat')
